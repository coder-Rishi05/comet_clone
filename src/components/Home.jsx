...
const Home = () => {
  return (
    <div className="w-full  gap-10 flex items-center py-20 flex-col ">
      ...
      <div className="flex items-center gap-4  bg-neutral-900  px-6 py-3 hover:scale-100 hover:cursor-pointer hover:transition-all duration-200 rounded-full text-xl font-normal  download-btn">
        <i className="p-4 bg-white rounded-full ">
          <GoDownload className="text-black  bg-white rounded-full " />
        </i>
        <p className="text-white">Download Comet</p>
      </div>
    </div>
  );
};
